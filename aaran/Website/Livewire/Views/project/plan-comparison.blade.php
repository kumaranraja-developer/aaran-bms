                    ...
                    <tr>
                        <th class="flex justify-center items-center py-5 gap-2 h-full">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                >
                                <div
                                    class="w-12 h-7 bg-black rounded-full peer peer-checked:bg-black transition-colors duration-300"></div>
                                <div
                                    class="absolute left-1 top-1 w-5 h-5 bg-white rounded-full transition-transform duration-300 peer-checked:translate-x-5"></div>
                            </label>
                        ...
                        <th class="border border-gray-300 border-collapse py-5 text-2xl  font-normal"
                            id="enterprisePrice">$49
                        </th>
