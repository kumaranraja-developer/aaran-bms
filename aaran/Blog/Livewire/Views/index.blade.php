            ...
            <div class="bg-white p-2 border border-gray rounded-lg">
               <div class="border border-gray-300  bg-gray-100 rounded-lg">
                   <div class="relative w-full group">
                       ...
                       <div class="absolute bottom-0 left-0 right-0 grid grid-cols-2 bg-gray-100 opacity-0 translate-y-0 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
                           <!-- Search Icon -->
                   ...
                   <div class="mx-3">
                       ...
                       <div class="line-clamp-3 text-sm leading-relaxed text-dark-7">Penatibus et magnis dis parturient montes, nascetur ridiculus mus. Etiam ultrices metus ut enim biben dum, vitae fringilla. Penatibus et magnis dis parturient montes, nascetur ridiculus mus. Etiam ultrices metus ut enim biben dum, vitae fringilla.</div>
                           ...
                           <div class="flex">
                               ...
                               <div class="flex gap-1 mr-3">
                                   <div class="w-5 flex items-center">
                                       <svg class="cursor-pointer stroke-blue-500" viewBox="0 -0.5 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
