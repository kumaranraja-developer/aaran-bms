                ...
                <div class="w-full lg:max-w-md">
                    ...
                    <ul>
                        <li class="flex items-center py-2 space-x-4 xl:py-3">
                            ...
                            <span class="font-medium text-zinc-500">Faster Processing and Delivery</span>
                        </li>
                        <li class="flex items-center py-2 space-x-4 xl:py-3">
                            ...
                            <span class="font-medium text-zinc-500">Out of the Box Tracking and Monitoring</span>
                        </li>
                        <li class="flex items-center py-2 space-x-4 xl:py-3">
                            ...
                            <span class="font-medium text-zinc-500">100% Protection and Security for Your App</span>
                        </li>
                    </ul>
                </div>
            </div>
