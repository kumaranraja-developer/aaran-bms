...
<div class="py-12 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"><!-- Wrapper for shutter animation -->

            <h2 class="text-3xl sm:text-4xl font-bold text-orange-500 mb-8 pt-10 text-center transition duration-700 ease-in-out transform hover:scale-105">
