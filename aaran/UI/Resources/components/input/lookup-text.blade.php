...
<div class="relative w-full">
    <input {{$attributes}} type="text" id="{{$name}}"
           ...
           focus:border-blue-600 peer dark:bg-dark dark:text-dark-9"
           placeholder=" "/>
    <label for="floating_outlined"
           class="absolute text-sm text-gray-500 dark:bg-dark dark:text-dark-9 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0]
           bg-white px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100
