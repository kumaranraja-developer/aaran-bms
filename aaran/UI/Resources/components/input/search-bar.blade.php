...
<div class="w-full grid grid-cols-[10%_90%] sm:flex flex-row space-x-4 group ">
        ...
        <div class="relative w-full md:w-max ">
            ...
            <label for="floating_outlined"
               ...
               scale-75 top-2 z-10 origin-[0] w-max bg-white dark:bg-dark dark:text-dark-9 px-2 peer-focus:px-2 peer-focus:text-blue-600  peer-placeholder-shown:scale-100
