<div>
    ...
    <x-Ui::forms.m-panel>
        ...
        <!-- Table Caption -------------------------------------------------------------------------------------------->
        <x-Ui::table.caption :caption="'Transport'">
            {{$list->count()}}
        </x-Ui::table.caption>
        ...
        <x-Ui::table.form>
            <x-slot:table_header>
                ...
                <x-Ui::table.header-text sortIcon="false" > Vehicle no </x-Ui::table.header-text>
            ...
            <x-slot:table_body>
                @foreach($list as $index=>$row)
                    <x-Ui::table.row>
                        ...
                        <x-Ui::table.cell-text center>{{$row->vehicle_no}}</x-Ui::table.cell-text>
        ...
        <x-Ui::forms.create :id="$vid">
            <div class="flex flex-col  gap-3">
                <div>
                    <x-Ui::input.floating wire:model="vname" label="Transport Name"/>
                    <x-Ui::input.error-text wire:model="vname"/>
                </div>

                <x-Ui::input.floating wire:model="vehicle_no" label="vehicle no"/>
